...
import com.fernandocejas.android10.sample.presentation.view.activity.ImagesToGiftActivity;
...
public class Navigator {
  ...
  /**
   * Goes to the Images to Gif screen
   *
   * @param context A Context needed to open the destiny activity.
   */
  public void navigateToImagesToGif(Context context) {
    if(context != null) {
      Intent intent = ImagesToGiftActivity.getCallingIntent(context);
